...
Plugin 'lervag/vimtex' " latex edit and compile
Plugin 'SirVer/ultisnips' " snip manager
...
Plugin 'tpope/vim-abolish' " replaces commonly mispelled words
...
try
source ~/.config/nvim/vim_runtime/my_plugins_config.vim
catch
endtry
""""""""""""""""""""""""""""""""""""""""'
set exrc
